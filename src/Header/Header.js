...
function Header(props) {
    const cart =
        <li className="nav-item">
            <NavLink className="nav-link active" to="/lk">Выбранно&nbsp;
                <span style={{color : "red"}}>{props.cart.length}</span>
            </NavLink>
        </li>
    const dellCart =
        <li className="nav-item">
            <a className="nav-link active" href="#" onClick={props.clearCart}>Очистить</a>
        </li>
    return (
        <div>
            <div id="header" className="row">
                ...
                <div id="logo" className="col-md-2">
                    <div className="well"><NavLink to="/"><img src={logoch} height="50px" alt="ContentCH"
                                                               onClick={props.handleClickLogoHeader}/></NavLink></div>
                </div>
                <div id="header-content" className="col-md-4">
                    <div className="well"></div>
                </div>
                <div id="logo" className="col-md-2">
                    <div className="well"><img src={logolego} height="50px" alt=""/></div>
                </div>
                <div id="header-content" className="col-md-4">
                    <div className="well"></div>
                </div>
            ...
            <div className="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb"
                        style={{background: "#f0f0f0", display: "none"}}> {/* remove "display none"*/}
